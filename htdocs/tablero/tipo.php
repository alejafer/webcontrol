...
<?php 
    ...
    $proceso =$link->query("SELECT count(*) as cantidad FROM `tipousuario`  where id <> 3 and id <> 2 and id <> 100");
    ...
    <div  id="app"  class="page-wrapper default-theme sidebar-bg bg1 toggled">
        ...
        <div class="caracterizacion card shadow mb-4" style="display: none;">
          <div class="card-header py-3">
            <h6 class="m-0 font-weight-bold text-primary">Datos del tipo de usuario</h6>
          </div>
          <div class="card-body">
                    ...
                    <div class="container" style="margin: 0px; max-width: 20040px;">  
                        <div class="row" style="margin-bottom: 10px;">
                            <div class="col-xl-6 col-md-12" style="text-align: left;">
                                ...
                                <input class="form-control"  name="Identificador" type="number" placeholder="Identificador" required>                               
                            </div>
                            <div class="col-xl-6 col-md-12" style="text-align: left;">
        ...
        <div class="tablausuarios card shadow mb-4" >
            ...
            <div class="card-body">
              <div class="table-responsive">
                    ...
                    <?php foreach ($link->query("SELECT * FROM `tipousuario`  where id <> 3 and id <> 2 and id <> 100") as $row){ // aca puedes hacer la consulta e iterarla  ?> 
                    <tr >
                        <td > <span id="identificacion<?php echo $row['id'] ?>"><?php echo $row['id'] ?></span></td>                       
                        ...
                        ?></td>
                        <td><center><button value="<?php echo $row['id'] ?>" id="<?php echo $row['id'] ?>" onclick="document.getElementById('id01').style.display='block'" class="btn-primary edit"><i class="fas fa-user-edit"></i></button></center></td>
                        <td><center><button value="<?php echo $row['id'] ?>" id="<?php echo $row['id'] ?>" onclick="document.getElementById('id02').style.display='block'" class="btn-primary delete"><i class="fas fa-user-times"></i></i></button></center></td>                         
                     </tr>
                    <?php
                        }
                    ?>
        ...
        <div id="id01" class="modal1" id="edit">
            ...
            <form id="form" class="modal1-content" enctype="multipart/form-data" action="../static/php/modificartipo.php" method="POST">
                <div class="container">
                    ...
                    <div class="row">
                        <div class="col-lg-6 form-group" style="text-align: left;">
                            ...
                            <input type="number" class="form-control" id="eidentificacion" aria-describedby="emailHelp" placeholder="Ingrese su nombre" name="editid" required="true" >
        ...
        <div id="id02" class="modal2" id="eliminar" >
            ...
            <form id="form" class="modal2-content" enctype="multipart/form-data" action="../static/php/desactivartipo.php" method="POST">
                <div class="container">
                    <h1 style="font-size: 60px;color: #2199be;text-align: center;" class="vc_custom_heading vc_custom_1513035251258" ><b>CAMBIAR ESTADO</b></h1><h1 style="font-size: 50px;color: #2199be;text-align: center;" class="vc_custom_heading ">¿Está seguro de cambiar el estado del tipo de usuario?</h1>
                    <div class="row">
