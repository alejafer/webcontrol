...
<?php 
    ...
    $proceso =$link->query("SELECT count(*) as cantidad FROM control where estado='2' ");
    
     if($resultado = mysqli_fetch_array($proceso)){
        $cantidad = $resultado['cantidad'];
    }

    $proceso =$link->query("SELECT count(*) as cantidad FROM control where estado='1' ");
    
     if($resultado = mysqli_fetch_array($proceso)){
        $cantidad2 = $resultado['cantidad'];
    }
...
<body class="bodyMenu">
    ...
    <div  id="app"  class="page-wrapper default-theme sidebar-bg bg1 toggled">
              ...
              <div class="card border-left-primary shadow h-100 py-2">
                <div class="card-body">
                  <div class="row no-gutters align-items-center">
                    <div class="col mr-2">
                      <div class="text-xs font-weight-bold text-primary text-uppercase mb-1">Usuarios ingresados</div>
                      <div class="h5 mb-0 font-weight-bold text-gray-800"><?= $cantidad2 ?></div>
                    </div>
                    <div class="col-auto">
            ...
            <div class="col-xl-6 col-md-6 mb-4">
              ...
              <div class="card border-left-success shadow h-100 py-2">
                <div class="card-body">
                  <div class="row no-gutters align-items-center">
                    <div class="col mr-2">
                      <div class="text-xs font-weight-bold text-success text-uppercase mb-1">Historial</div>
        ...
        <div class="caracterizacion card shadow mb-4">
            <div class="card-header py-3">
              <h6 class="m-0 font-weight-bold text-primary">Registro de entradas </h6>
            </div>
            <div class="card-body">
                ...
                <table id="example4" class="table table-striped table-bordered" style="width:100%">                
                    <thead>
                        <tr center>
                            ...
                            <th>Apellido</th>
                            <th>Razón</th>
                            <th>Tipo&nbspusuario</th>
                            <th>Fecha_entrada</th>
                          </tr>
                    </thead>
                    <?php foreach ($link->query("SELECT c.usuarios_identificacion as identificacion, t.nombre as nombret, a.nombre1, a.apellido1, r.nombre as razon, c.fechaentrada as fechaentrada FROM control c, usuarios a, razones r, tipousuario t 
                        where c.estado='1' and c.usuarios_identificacion = a.identificacion and r.idrazon = c.razones_idrazon and t.id = c.tipousuario_id;" ) as $row){ // aca puedes hacer la consulta e iterarla  ?> 
                    <tr>
        ...
        <div class="tablaasignar card shadow mb-4" style="display: none;">
           <div class="card-header py-3">
              <h6 class="m-0 font-weight-bold text-primary">Registro de entradas y salidas</h6>
            </div>
            <div class="card-body">
              <div class="table-responsive">
                ...
                <table id="example3" class="table table-striped table-bordered" style="width:100%">                
                    ...
                    <?php foreach ($link->query("SELECT c.usuarios_identificacion as identificacion, t.nombre as nombret, a.nombre1, a.apellido1, r.nombre as razon, c.fechaentrada as fechaentrada, c.fechasalida FROM control c, usuarios a, razones r, tipousuario t where c.estado='2' and c.usuarios_identificacion = a.identificacion and r.idrazon = c.razones_idrazon and t.id = c.tipousuario_id;" ) as $row){ // aca puedes hacer la consulta e iterarla  ?> 
                    <tr>
                        <td><?php echo $row['identificacion'] ?></td>
                        <td><?php echo $row['nombre1'] ?></td>
                        <td><?php echo $row['apellido1'] ?></td>
