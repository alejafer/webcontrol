...
<?php 
    ...
    $proceso =$link->query("SELECT count(*) as cantidad FROM usuarios where  (tipousuario_id <> 2 and tipousuario_id <> 3)");
...
$(document).ready(function() {
    $(document).on('click', '.edit', function() {
        ...
        var nombre2 = $('#nombre2' + id).text();
        var apellido2 = $('#apellido2' + id).text();
        ...
        $('#enombre2').val(nombre2);
        $('#eapellido2').val(apellido2);
        $('#ecorreo').val(correo);
...
<body class="bodyMenu">
    ...
    <div  id="app"  class="page-wrapper default-theme sidebar-bg bg1 toggled">
        ...
        <div class="row">
              ...
              <div class="card border-left-primary shadow h-100 py-2">
                <div class="card-body">
                  <div class="row no-gutters align-items-center">
                    <div class="col mr-2">
                      <div class="text-xs font-weight-bold text-primary text-uppercase mb-1">Cargar Datos</div>
            ...
            <div class="col-xl-4 col-md-4 mb-4">
              <a style="text-decoration:none" href="#" id="individual">
              <div class="card border-left-info  shadow h-100 py-2">
                <div class="card-body">
                  <div class="row no-gutters align-items-center">
                    <div class="col mr-2">
                      <div class="text-xs font-weight-bold text-info  text-uppercase mb-1">Registro individual</div>
                      <div class="h5 mb-0 font-weight-bold text-gray-800"><?= $cantidad ?></div>
                    </div>
                    <div class="col-auto">
        ...
        <div class="caracterizacion card shadow mb-4" style="display: none;">
            ...
            <div class="outer-container">
                ...
                name="frmExcelImport" id="frmExcelImport" enctype="multipart/form-data" >
                    <div class="upload-btn-wrapper">    
                        ...
                        <div class="container">
                            <h3>Importa el archivo con los datos de los usuarios</h2> 
         ...
         <div class="individual card shadow mb-4" style="display: none;">
          <div class="card-header py-3">
          ...
          <div class="card-body">
            ...
            <div class="outer-container">
                <form action="../static/php/individual.php" method="POST"
                name="frmExcelImport" id="frmExcelImport" enctype="multipart/form-data">
                            ...
                            <div class="col-lg-3 col-md-12" style="text-align: left;">
                                <div class="form-group">
                                    ...
                                    <select name="idusuario" class="form-control" id="exampleFormControlSelect1" required="">
                                      ...
                                      <?php foreach ($link->query("SELECT id, nombre FROM `tipousuario` where (id <> 2 and id <> 3)" ) as $row){ ?> 
                ...
                <table id="example4" class="table table-striped table-bordered" style="width:100%">                
                    <thead>
                        <tr center>
                            ...
                            <th>Nombre</th>
                            <th>Segundo&nbspNombre</th>
                            <th>Apellido</th>
                            <th>Segundo&nbspApellido</th>
                            <th>Telefono</th>
                            <th>Tipo&nbspde&nbspusuario</th>
                            <th>Tarjeta</th>
                            <th>Correo</th>
                            <th>Estado</th>
                            <th>Modificar</th>
                    ...
                    <?php foreach ($link->query("SELECT * FROM `usuarios`, tipousuario where id = tipousuario_id  and (id <> 2 and id <> 3)" ) as $row){ // aca puedes hacer la consulta e iterarla  ?> 
                    <tr>
                        <td><span id="identificacion<?php echo $row['identificacion'] ?>"><?php echo $row['identificacion'] ?></span></td>
                        <td><span id="nombre<?php echo $row['identificacion'] ?>"><?php echo $row['nombre1'] ?></span></td>
                        <td><span id="nombre2<?php echo $row['identificacion'] ?>"><?php echo $row['nombre2'] ?></span></td>
                        <td><span id="apellido<?php echo $row['identificacion'] ?>"><?php echo $row['apellido1'] ?></span></td>
                        <td><span id="apellido2<?php echo $row['identificacion'] ?>"><?php echo $row['apellido2'] ?></span></td>
                        <td><span id="telefono<?php echo $row['identificacion'] ?>" ><?php echo $row['telefono'] ?> </span></td>
                        <td><span id="tipo<?php echo $row['identificacion'] ?>"><?php echo $row['nombre'] ?></span></td>
                        <?php
                            echo "<td>";
                                  $estado = $row['tarjeta'];
                                  if($estado == '1'){
                        ...
                        ?> </td>
                        <td><span id="correo<?php echo $row['identificacion'] ?>"><?php echo $row['correo'] ?></span></td>
                        <?php
                            echo "<td>";
                                  $estado = $row['estado'];
                                  if($estado == '1'){
        ...
        <div id="id01" class="modal1" id="edit">
            ...
            <form id="form" class="modal1-content" enctype="multipart/form-data" action="../static/php/modificaracademia.php" method="POST">
                <div class="container">
                    ...
                    <div class="row">
                        <div class="col-lg-6 form-group" style="text-align: left;">
                            <label for="Nombre"><h2 style="color: #2199be;text-align: left" class="vc_custom_heading">Segundo Nombre </h2></label>
                            <input type="text" class="form-control" id="enombre2" aria-describedby="emailHelp" placeholder="Ingrese su nombre" name="editnombre2" required="true">
                            
                        </div>
                        <div class="col-lg-6 form-group" style="text-align: left;">
                            <label for="Apellido"><h2 style="color: #2199be;text-align: left" class="vc_custom_heading">Segundo Apellido </h2></label>
                            <input type="text" class="form-control" id="eapellido2" aria-describedby="emailHelp" placeholder="Ingrese su apellido" name="editapellido2" required="true">
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-6 form-group" style="text-align: left;">
                            ...
                            <input type="tel" class="form-control" id="etelefono" aria-describedby="emailHelp" placeholder="Ingrese su Telefono" name="edittelefono" required="true">
                            
                        </div>  
                    </div>
                    <div class="row">
                        <div class="col-lg-12 form-group" style="text-align: left;">
                            <label for="Correo"><h2 style="color: #2199be;" class="vc_custom_heading">Correo </h2></label>
                            <input type="email" class="form-control" id="ecorreo" aria-describedby="emailHelp" placeholder="Ingrese su Correo" name="editcorreo" required="true">   
                        </div>  
                    </div>
                    <div class="row">
                        <div class="col-lg-6 col-md-12" style="text-align: left;">
                            <div class="form-group">
                                <label for="valtipo"><h2 style="color: #2199be;" class="vc_custom_heading">Tipo de usuario </h2></label>
                                <select name="editidusuario" class="form-control" id="valtipo" required>
        ...
        <div id="id02" class="modal2" id="eliminar" >
            ...
            <form id="form" class="modal2-content" enctype="multipart/form-data" action="../static/php/desactivaracademia.php" method="POST">
                <div class="container">
                    <h1 style="font-size: 60px;color: #2199be;text-align: center;" class="vc_custom_heading vc_custom_1513035251258" ><b>CAMBIAR ESTADO</b></h1><h1 style="font-size: 50px;color: #2199be;text-align: center;" class="vc_custom_heading ">¿Está seguro de cambiar el estado del usuario?</h1>
                    <div class="row">
